...
import { calculateSha1, copyFileAndMakeWritable, removeFolders, sanitizeForFilePath, toPosixPath } from 'playwright-core/lib/utils';
...
class SummaryHtmlReporter extends EmptyReporter {
